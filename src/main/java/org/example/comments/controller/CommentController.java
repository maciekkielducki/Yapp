...
public class CommentController {
    ...
    @GetMapping("/{postId}")
    public ResponseEntity<List<CommentResponse>> getCommentsByPost(@PathVariable Long postId, @RequestParam Long loggedUserId) {
        List<CommentResponse> comments = commentService.getCommentsByPost(postId, loggedUserId);
